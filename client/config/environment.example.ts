...
// Copy this file to environment.ts and update the SERVER_URL values
...
export const config: EnvironmentConfig = {
  ...
  // IMPORTANT: Update these URLs with your actual server endpoints
  SERVER_URL: IS_PRODUCTION
    ? 'https://your-app.onrender.com'  // Replace with your production server URL
    : 'http://localhost:5001',  // For mobile device testing, use your local IP (e.g., http://192.168.1.x:5001)
};
